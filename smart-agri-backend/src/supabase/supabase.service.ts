...
export class SupabaseService {
    ...
    constructor(private configService: ConfigService) {
        ...
        if (!supabaseUrl || !supabaseKey) {
            this.logger.warn('SUPABASE_URL or SUPABASE key is missing from environment variables.');
        }
        ...
        if (this.configService.get<string>('SUPABASE_SERVICE_ROLE_KEY')) {
            ...
            this.logger.warn('SUPABASE_SERVICE_ROLE_KEY missing; falling back to publishable/anon key for Supabase client.');
        }
